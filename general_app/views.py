...
class MathTrainingResultsView(LoginRequiredMixin, ListView):
    ...
    template_name = 'general_app/mathtraining_results.html'  # замените на своё имя шаблона
...
class LoginRegisterView(View):
    ...
    def post(self, request):
        ...
        # Возвращаемся на страницу входа/регистрации с предоставленными формами
        # и информацией об ошибках, если они есть
        return render(request, 'general_app/entry.html', {
            'login_form': login_form,
            'register_form': register_form
        })
